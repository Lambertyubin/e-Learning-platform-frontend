...
function Sidebar() {
  ...
  for (let i = 0; i < nav.length; i++) {
    navigation.push(
      <li key={"nav-" + i + "-" + nav[i].slug}>
        <Link to={nav[i].slug} className={"aic link noul flex c333"}>
  ...
  return (
    <div className="sidebar rel">
      <div className="center logo bl">
        <h2 className="logo bl">E-LEARNING</h2>
      </div>
      ...
      <div className="updated-course flex aic">
        ...
        <div className="lbl s15 fontb c333">
          Updated Courses
          <h2 className="author s13 c777">by John Paul</h2>
        </div>
      </div>
      ...
      <div className="me flex aic">
        {global.fire ? (
          ...
          <Link to={"oauth"} className={"aic link noul flex c333"}>
